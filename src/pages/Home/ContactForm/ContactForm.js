  ...
  return (
   ...
   >
        ...
        >
         ...
         <form className="max-w-md mx-auto p-6  drop-shadow-xl">
      <div className="mb-4">
      ...
      <div className="flex justify-center">
        <button
          className="bg-primary text-white font-bold py-2 px-4 rounded focus:outline-none focus:shadow-outline w-full md:w-20 lg:w-20"
          type="submit"
        >
          Submit
        </button>
